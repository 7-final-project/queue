...
public class QueueServiceV2 {
    ...
    // 대기열 등록
    public void enrollWaitingListBy(ReservationCreateEventDTO event) {

        // Redis에 예약 정보 저장
        redisMessagePublisherV2.addWaitingListBy(event.getRestaurantId(), event.getReservationId());
    ...
    public QueueGetResDTOV2 getQueueInfoBy(Long restaurantId, Long reservationId) {
        ...
        return redisMessagePublisherV2.getQueueInfoBy(restaurantId, reservationId);
    }
}
